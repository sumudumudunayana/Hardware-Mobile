      ...
      <ScrollView
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.value}>{item.itemDistributor}</Text>
          </View>

          {/* COST PRICE */}
          <View style={styles.infoRow}>
            <Text style={styles.label}>Cost Price</Text>
            <Text style={styles.value}>Rs. {item.itemCostPrice}</Text>
          </View>

          {/* SELLING PRICE */}
          <View style={styles.infoRow}>
            <Text style={styles.label}>Selling Price</Text>
            <Text style={styles.value}>Rs. {item.itemSellingPrice}</Text>
          </View>

          {/* LABELED PRICE */}
          <View style={styles.infoRow}>
            <Text style={styles.label}>Labeled Price</Text>
            <Text style={styles.value}>Rs. {item.itemLabeledPrice}</Text>
          </View>
        </View>
      </ScrollView>
    </View>
